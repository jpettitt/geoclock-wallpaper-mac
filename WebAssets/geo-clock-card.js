 ...
 */function fe(e){return me({...e,state:!0,attribute:!1})}const ge=Math.PI/180,ve=180/Math.PI,ye=Date.UTC(2e3,0,1,12,0,0),be=e=>((e+180)%360+360)%360-180;function $e(e){const t=(e.getTime()-ye)/864e5,i=280.46+.9856474*t,o=(357.528+.9856003*t)*ge,s=(i+1.915*Math.sin(o)+.02*Math.sin(2*o))*ge,r=(23.439-4e-7*t)*ge,n=Math.asin(Math.sin(r)*Math.sin(s))*ve,a=Math.atan2(Math.cos(r)*Math.sin(s),Math.cos(s))*ve,l=be(i-a),h=e.getUTCHours()+e.getUTCMinutes()/60+e.getUTCSeconds()/3600+e.getUTCMilliseconds()/36e5;return{lat:n,lon:be(-15*(h-12)-l)}}const we=Math.PI/180,ke=180/Math.PI,_e=1e-4;function xe(e,t={}){const i=t.stepDeg??1,o=(t.centerLon??180)-180;let s=e.lat;Math.abs(s)<_e&&(s=s>=0?_e:-1e-4);const r=Math.tan(s*we),n=[];for(let t=0;t<=360;t+=i){const i=(o+t-e.lon)*we,s=Math.atan(-Math.cos(i)/r)*ke;n.push([t,s])}return n}function ze(e,t,i,o,s=180){return{x:((t-(s-180))%360+360)%360/360*i,y:(90-e)/180*o}}function Te(e,t,i){const o=[];for(const[s,r]of e){const e=s/360*t,n=(90-r)/180*i;o.push(`${e.toFixed(2)},${n.toFixed(2)}`)}return o.join(" ")}const Ae=44;function Se(e,t,i=180){const o=function(e,t,i=180){const o=e.getUTCHours()+e.getUTCMinutes()/60+e.getUTCSeconds()/3600,s=t/24,r=i-180,n=[];for(let e=0;e<=24;e++){const t=r+15*e;let i=t/15;for(;i>12;)i-=24;for(;i<=-12;)i+=24;const a=Math.round(((o+t/15)%24+24)%24)%24;n.push({offset:i,realLon:t,centerX:e*s,hour12:(a+11)%12+1,isNoon:12===a,isMidnight:0===a})}return n}(e,t,i),s=t/24,r=[];for(let e=1;e<24;e++)r.push(e*s);return Z`
  ...
  `}setConfig(e){if(!e)throw new Error("geo-clock-card: missing config");const t=e.imageryBase??new URL(".",import.meta.url).href,i=function(e){if(null==e)return;const t=e instanceof Date?e:new Date(e);return Number.isFinite(t.getTime())?t:void 0}(e.now);this.config={twilightDegrees:Ze(e.twilightDegrees??8,1,18),updateInterval:Ze(e.updateInterval??1,1,600),showUTC:e.showUTC??!0,showTimezoneBand:e.showTimezoneBand??!0,showTimezoneBoundaries:e.showTimezoneBoundaries??!0,showTimezonePopup:e.showTimezonePopup??!0,timezoneLineColor:We(e.timezoneLineColor)??"rgba(255, 255, 255, 0.18)",dayBrightness:Ze(e.dayBrightness??1.15,0,5),nightContrast:Ze(e.nightContrast??1,0,5),twilightColor:We(e.twilightColor)??"#463701",twilightOpacity:Ze(e.twilightOpacity??.26,0,1),imageryBase:t.endsWith("/")?t:t+"/",center:e.center??"sun",centerLongitude:"number"==typeof e.centerLongitude?Ze(e.centerLongitude,-180,180):void 0,centerEntity:e.centerEntity,showHomeMarker:e.showHomeMarker??!1,showHomeMarkerLabel:e.showHomeMarkerLabel??!1,markers:qe(e.markers),markerLabelMode:"hover"===e.markerLabelMode?"hover":"always",markerColor:We(e.markerColor),markerShowDay:e.markerShowDay??!0,mainTimeSource:Ke(e.mainTimeSource),mainTimeEntity:e.mainTimeEntity,frozenNow:i};const o=i??new Date;this.displayNow=o,this.mapNow=o,this.tzPolygons=null,this.tzIanaPolygons=null,this.tzPolygonsCenterLon=null,this.restartTimer(),this.maybeLoadTimezones(),this.maybeLoadIanaTimezones()}connectedCallback(){if(super.connectedCallback(),!this.config?.frozenNow){const e=new Date;this.displayNow=e,this.mapNow=e}this.attachVisibilityObservers(),this.restartTimer(),this.maybeLoadTimezones(),this.maybeLoadIanaTimezones()}disconnectedCallback(){super.disconnectedCallback(),this.stopTimer(),this.clearDismissTimer(),this.detachVisibilityObservers()}attachVisibilityObservers(){"undefined"==typeof IntersectionObserver||this.intersectionObserver||(this.intersectionObserver=new IntersectionObserver(e=>{const t=e[e.length-1];this.intersecting=!t||t.isIntersecting,this.recomputeVisibility()},{threshold:0}),this.intersectionObserver.observe(this)),"undefined"==typeof document||this.onTabVisibility||(this.onTabVisibility=()=>this.recomputeVisibility(),document.addEventListener("visibilitychange",this.onTabVisibility))}detachVisibilityObservers(){this.intersectionObserver?.disconnect(),this.intersectionObserver=void 0,this.onTabVisibility&&"undefined"!=typeof document&&document.removeEventListener("visibilitychange",this.onTabVisibility),this.onTabVisibility=void 0}recomputeVisibility(){const e="undefined"==typeof document||"hidden"!==document.visibilityState,t=this.intersecting&&e;if(t!==this.isCardVisible){if(this.isCardVisible=t,t){const e=new Date;this.displayNow=e,this.mapNow=e}this.restartTimer()}}restartTimer(){if(this.stopTimer(),!this.config||!this.isConnected)return;if(this.config.frozenNow)return;const e=this.isCardVisible?1e3*this.config.updateInterval:18e5;this.timer=setInterval(()=>this.tick(),e)}tick(){const e=new Date;this.displayNow=e,e.getTime()-this.mapNow.getTime()>=10546.875&&(this.mapNow=e)}stopTimer(){void 0!==this.timer&&(clearInterval(this.timer),this.timer=void 0)}maybeLoadTimezones(){if(!this.config?.showTimezoneBoundaries||null!==this.tzData)return;(function(e){return He&&Ne===e||(Ne=e,He=fetch(e).then(e=>{if(!e.ok)throw new Error(`tz fetch failed: ${e.status}`);return e.json()})),He})(this.config.imageryBase+"timezones.json").then(e=>{this.tzData=e,this.requestUpdate()}).catch(e=>{console.warn("geo-clock-card: timezone overlay failed to load:",e)})}maybeLoadIanaTimezones(){if(!this.config||null!==this.tzIanaData)return;const e=this.config.markers.length>0,t="entity"===this.config.mainTimeSource,i="home"===this.config.mainTimeSource&&"string"!=typeof this.hass?.config?.time_zone;if(!(this.config.showTimezoneBoundaries||e||t||i))return;(function(e){return Ce&&Me===e||(Me=e,Ce=fetch(e).then(e=>{if(!e.ok)throw new Error(`iana tz fetch failed: ${e.status}`);return e.json()})),Ce})(this.config.imageryBase+"timezones-iana.json").then(e=>{this.tzIanaData=e,this.requestUpdate()}).catch(e=>{console.warn("geo-clock-card: IANA timezone overlay failed to load:",e)})}static{this.FALLBACK_CENTER_LON=0}resolveCenterLon(e){if(!this.config)return $e(e).lon;switch(this.config.center){case"home":{const e=this.hass?.config?.longitude;return"number"==typeof e?e:(this.warnFallback("home","hass.config.longitude is not set; falling back to Greenwich (0°)"),Re.FALLBACK_CENTER_LON)}case"longitude":return"number"==typeof this.config.centerLongitude?this.config.centerLongitude:(this.warnFallback("longitude","centerLongitude not set; falling back to Greenwich (0°)"),Re.FALLBACK_CENTER_LON);case"entity":{const e=this.config.centerEntity,t=e?this.hass?.states?.[e]:void 0,i=t?.attributes?.longitude;return"number"==typeof i?i:(this.warnFallback("entity",e?`entity '${e}' has no numeric longitude attribute; falling back to Greenwich (0°)`:"centerEntity not set; falling back to Greenwich (0°)"),Re.FALLBACK_CENTER_LON)}default:return $e(e).lon}}warnFallback(e,t){const i=`${e}|${t}`;this.warnedFallback!==i&&(this.warnedFallback=i,console.warn(`geo-clock-card: center mode '${e}' — ${t}`))}resolveHomeLatLon(){const e=this.hass?.config?.latitude,t=this.hass?.config?.longitude;return"number"!=typeof e||"number"!=typeof t?null:{lat:e,lon:t}}resolveMainTimezone(){if(this.config)switch(this.config.mainTimeSource){case"device":return;case"home":{const e=this.hass?.config?.time_zone;if("string"==typeof e&&e)return e;const t=this.resolveHomeLatLon();return t&&this.tzIanaData?Pe(this.tzIanaData,t.lat,t.lon)??void 0:void 0}case"entity":{const e=this.config.mainTimeEntity,t=e?this.hass?.states?.[e]:void 0,i=t?.attributes?.latitude,o=t?.attributes?.longitude;return"number"==typeof i&&"number"==typeof o&&this.tzIanaData?Pe(this.tzIanaData,i,o)??void 0:void 0}}}resolveMarkers(){if(!this.config||0===this.config.markers.length)return[];const e=[];for(const t of this.config.markers){const i=this.hass?.states?.[t.entity];if(!i)continue;const o=i.attributes?.latitude,s=i.attributes?.longitude;if("number"!=typeof o||"number"!=typeof s)continue;const r="string"==typeof i.attributes?.friendly_name?i.attributes.friendly_name:t.entity,n="string"==typeof t.label&&t.label.trim()||r,a=this.tzIanaData?Pe(this.tzIanaData,o,s):null;e.push({entity:t.entity,label:n,color:We(t.color)??this.config.markerColor,lat:o,lon:s,tzid:a})}return e}render(){if(!this.config)return V``;const e=this.config.frozenNow??this.mapNow,t=this.config.frozenNow??this.displayNow,i=this.resolveCenterLon(e),o=$e(e),s=xe(o,{centerLon:i}),r=function(e,t={}){const i=xe(e,t);let o=e.lat;Math.abs(o)<_e&&(o=o>=0?_e:-1e-4);const s=o>0?-90:90;return[...i,[360,s],[0,s]]}(o,{centerLon:i}),n=Te(r,Fe,je),a=Te(s,Fe,je),l=2*this.config.twilightDegrees*je/180,h=Math.max(.5,l/8),c=Math.max(4,.55*l),d=Math.max(1,l/5),p=this.config.imageryBase+function(e){const t=e.getUTCDate();let i,o=e.getUTCMonth()+1;return t<8?i="start":t<23?i="mid":(i="start",o=12===o?1:o+1),`blue-marble-${String(o).padStart(2,"0")}-${i}-2048.jpg`}(e),u=this.config.imageryBase+"black-marble-2048.jpg",m=(-i/360*Fe%Fe+Fe)%Fe;if(this.config.showTimezoneBoundaries){const e=this.tzPolygonsCenterLon!==i;this.tzData&&(e||null===this.tzPolygons)&&(this.tzPolygons=function(e,t,i,o=180){const s=[];for(const r of e.features){const e="Polygon"===r.geometry.type?[r.geometry.coordinates]:r.geometry.coordinates;let n="";for(const s of e)0!==s.length&&(n+=Ee(s[0],t,i,o));n&&s.push({offset:r.properties.zone,offsetLabel:Ue(r.properties.zone,r.properties.time_zone),name:r.properties.name??null,places:Be(r.properties.places??""),d:n})}return s}(this.tzData,Fe,je,i)),this.tzIanaData&&(e||null===this.tzIanaPolygons)&&(this.tzIanaPolygons=function(e){const t=e=>{let t=1/0,i=1/0,o=-1/0,s=-1/0;const r=/[ML]([\d.\-]+),([\d.\-]+)/g;let n;for(;n=r.exec(e);){const e=parseFloat(n[1]),r=parseFloat(n[2]);e<t&&(t=e),e>o&&(o=e),r<i&&(i=r),r>s&&(s=r)}return isFinite(t)?(o-t)*(s-i):0};return[...e].sort((e,i)=>t(i.d)-t(e.d))}(function(e,t,i,o=180){const s=[];for(const r of e.features){const e="Polygon"===r.geometry.type?[r.geometry.coordinates]:r.geometry.coordinates;let n="";for(const s of e)0!==s.length&&(n+=Ee(s[0],t,i,o));n&&s.push({tzid:r.properties.tzid,cityLabel:De(r.properties.tzid),d:n})}return s}(this.tzIanaData,Fe,je,i))),this.tzPolygonsCenterLon=i}const f=this.resolveMainTimezone(),g=function(e,t){return e.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit",second:"2-digit",timeZoneName:"short",...t?{timeZone:t}:{}})}(t,f),v=function(e){const t=String(e.getUTCHours()).padStart(2,"0"),i=String(e.getUTCMinutes()).padStart(2,"0"),o=String(e.getUTCSeconds()).padStart(2,"0");return`${t}:${i}:${o} UTC`}(t),y=function(e,t){return e.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric",year:"numeric",...t?{timeZone:t}:{}})}(t,f),b=this.resolveMarkers(),$=this.config.showTimezoneBand,w=$?-44:0,k=$?1068:je,_=`aspect-ratio: 2048 / ${k}; --geo-day-brightness: ${this.config.dayBrightness}; --geo-night-contrast: ${this.config.nightContrast}; --geo-twilight-color: ${this.config.twilightColor}; --geo-twilight-opacity: ${this.config.twilightOpacity}; --geo-tz-line: ${this.config.timezoneLineColor};`;return V`
      <div class="frame" style="${_}">
        ...
        >
          <defs>
            ...
            <mask
              ...
              height="${je}"
            >
              <rect width="${Fe}" height="${je}" fill="black" />
              <polygon points="${n}" fill="white" filter="url(#feather)" />
            </mask>
            <filter
              id="twilight-blur"
              x="-3%"
          ...
          ${this.tzPolygons&&this.config.showTimezoneBoundaries?this.tzPolygons.map(e=>Z`<path class="tz-region" d="${e.d}"
                                 @pointerenter=${t=>this.onOffsetEnter(t,e)}
                                 @pointermove=${this.onZoneMove}
                                 @pointerleave=${this.onOffsetLeave}/>`):""}
          ${this.tzIanaPolygons&&this.config.showTimezoneBoundaries?this.tzIanaPolygons.map(e=>Z`<path class="tz-iana-region${this.hoveredIana===e?" is-active":""}" d="${e.d}"
        ...
        ${this.config.showHomeMarker?this.renderHomeMarkerOverlay(t,i,w,k):""}
        ${b.length>0?this.renderMarkerOverlay(b,t,i,w,k):""}
        <div class="readout">
          <div class="local-time">${g}</div>
          ${this.config.showUTC?V`<div class="utc-time">${v}</div>`:""}
        </div>
